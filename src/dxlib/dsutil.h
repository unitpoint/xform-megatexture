...
public:
    ...
    HRESULT Play3D( LPDS3DBUFFER p3DBuffer, DWORD dwPriority = 0, DWORD dwFlags = 0, LONG lFrequency = 0, DWORD dwApply = DS3D_IMMEDIATE );
    HRESULT Play3D( LPDS3DBUFFER p3DBuffer, DWORD dwPriority = 0, DWORD dwFlags = 0, LONG lVolume = 0, LONG lFrequency = 0, DWORD dwApply = DS3D_IMMEDIATE );
    HRESULT Stop();
    HRESULT Reset();
    BOOL    IsSoundPlaying();
};
