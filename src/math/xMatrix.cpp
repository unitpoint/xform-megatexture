...
const xMat2 mat2_zero(xVec2(0, 0), xVec2(0, 0));
const xMat2 mat2_identity(xVec2(1, 0), xVec2(0, 1));
...
bool xMat2::InverseSelf()
{
	...
	if (xMath::Fabs(det) < MATRIX_INVERSE_EPSILON) {
		return false;
	}
...
/*
============
xMat2::InverseFastSelf
============
*/
bool xMat2::InverseFastSelf()
{
	// 2+4 = 6 multiplications
	//		 1 division
	double det, invDet, a;
...
=============
*/
xString xMat2::ToString(int precision) const {
...
const xMat3 mat3_zero(xVec3(0, 0, 0), xVec3(0, 0, 0), xVec3(0, 0, 0));
const xMat3 mat3_identity(xVec3(1, 0, 0), xVec3(0, 1, 0), xVec3(0, 0, 1));
...
============
*/
void xMat3::ToVectors(xVec3 *forward, xVec3 *right, xVec3 *up) const
{
  if(forward)
    *forward = mat[0];
...
xMat3& xMat3::SetVectors(const xVec3& forward, const xVec3& right, const xVec3& up)
{
  mat[0] = forward;
  mat[1] = -right;
  mat[2] = up;
...
xAngles xMat3::ToAngles() const {
	...
	if (cp > 8192.0f * xMath::FLOAT_EPSILON) {
...
============
*/
xCQuat xMat3::ToCQuat() const {
	xQuat q = ToQuat();
	if (q.w < 0.0f) {
		return xCQuat(-q.x, -q.y, -q.z);
	}
	return xCQuat(q.x, q.y, q.z);
}
...
============
*/
xRotation xMat3::ToRotation() const {
	xRotation	r;
	float		trace;
	float		s;
	float		t;
	...
	r.angle = xMath::ACos(r.angle);
	if (xMath::Fabs(r.angle) < 1e-10f) {
...
/*
=================
xMat3::ToAngularVelocity
=================
*/
xVec3 xMat3::ToAngularVelocity() const {
	xRotation rotation = ToRotation();
...
/*
============
xMat3::InverseFastSelf
============
*/
bool xMat3::InverseFastSelf()
{
	// 18+3+9 = 30 multiplications
	//			 1 division
	xMat3 inverse;
...
=============
*/
xString xMat3::ToString(int precision) const {
	return xString::FloatArrayToString(ToFloatPtr(), Dimension(), precision);
}
...
const xMat4 mat4_zero(xVec4(0, 0, 0, 0), xVec4(0, 0, 0, 0), xVec4(0, 0, 0, 0), xVec4(0, 0, 0, 0));
const xMat4 mat4_identity(xVec4(1, 0, 0, 0), xVec4(0, 1, 0, 0), xVec4(0, 0, 1, 0), xVec4(0, 0, 0, 1));
...
============
*/
void xMat4::ToVectors(xVec3 *forward, xVec3 *right, xVec3 *up, xVec3 *translation) const
{
  if(forward){
	  forward->x = mat[0][0];
	  forward->y = mat[1][0];
...
xMat4& xMat4::SetVectors(const xVec3& forward, const xVec3& right, const xVec3& up, const xVec3& translation)
{
  mat[0][0] = forward.x;
  mat[1][0] = forward.y;
  mat[2][0] = forward.z;
...
/*
============
xMat4::InverseFastSelf
============
*/
bool xMat4::InverseFastSelf() {
#if 0
	// 84+4+16 = 104 multiplications
	//			   1 division
	double det, invDet;
...
=============
*/
xString xMat4::ToString(int precision) const {
	return xString::FloatArrayToString(ToFloatPtr(), Dimension(), precision);
}
...
const xMat5 mat5_zero(xVec5(0, 0, 0, 0, 0), xVec5(0, 0, 0, 0, 0), xVec5(0, 0, 0, 0, 0), xVec5(0, 0, 0, 0, 0), xVec5(0, 0, 0, 0, 0));
const xMat5 mat5_identity(xVec5(1, 0, 0, 0, 0), xVec5(0, 1, 0, 0, 0), xVec5(0, 0, 1, 0, 0), xVec5(0, 0, 0, 1, 0), xVec5(0, 0, 0, 0, 1));
...
/*
============
xMat5::InverseFastSelf
============
*/
bool xMat5::InverseFastSelf() {
#if 0
	// 280+5+25 = 310 multiplications
	//				1 division
	double det, invDet;
...
=============
*/
xString xMat5::ToString(int precision) const {
	return xString::FloatArrayToString(ToFloatPtr(), Dimension(), precision);
}
...
const xMat6 mat6_zero(xVec6(0, 0, 0, 0, 0, 0), xVec6(0, 0, 0, 0, 0, 0), xVec6(0, 0, 0, 0, 0, 0), xVec6(0, 0, 0, 0, 0, 0), xVec6(0, 0, 0, 0, 0, 0), xVec6(0, 0, 0, 0, 0, 0));
const xMat6 mat6_identity(xVec6(1, 0, 0, 0, 0, 0), xVec6(0, 1, 0, 0, 0, 0), xVec6(0, 0, 1, 0, 0, 0), xVec6(0, 0, 0, 1, 0, 0), xVec6(0, 0, 0, 0, 1, 0), xVec6(0, 0, 0, 0, 0, 1));
...
/*
============
xMat6::InverseFastSelf
============
*/
bool xMat6::InverseFastSelf() {
#if 0
	// 810+6+36 = 852 multiplications
	//				1 division
	double det, invDet;
...
=============
*/
xString xMat6::ToString(int precision) const {
	return xString::FloatArrayToString(ToFloatPtr(), Dimension(), precision);
}
